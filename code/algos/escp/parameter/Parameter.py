...
class Parameter:
    def __init__(self, parser=None, config_path=None, debug=False, information=None):
    ...
    def parse(self, parser):
        ...
        self.use_absorbing_state = False
        parser.add_argument('--use_absorbing_state', action='store_true', default=self.use_absorbing_state, 
                            help='add absorbing state for Hopper and Walker2d')
        self.register_param("use_absorbing_state")
        ...
        self.policy_freq = 2
        parser.add_argument('--policy_freq', type=int, default=self.policy_freq)
        self.register_param('policy_freq')

        self.autoalpha = False
        parser.add_argument('--autoalpha', action='store_true')
        self.register_param('autoalpha')
        
        self.alpha = 0.2
        parser.add_argument('--alpha', type=float, default=self.alpha, metavar='N')
        self.register_param('alpha')
    ...
    def get_experiment_description(self):
        ...
        description = f"EXPERIMENT: {self.short_name}\n"
